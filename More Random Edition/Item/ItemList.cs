    ...
    public class ItemList
	{
        ...
        public static void Initialize()
		{
			...
			{ 
				...
				{ ObjectIndexes.WoodFence.GetId(), new CraftableItem(ObjectIndexes.WoodFence.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.StoneFence.GetId(), new CraftableItem(ObjectIndexes.StoneFence.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.IronFence.GetId(), new CraftableItem(ObjectIndexes.IronFence.GetId(), CraftableCategories.ModerateAndNeedMany) },
				{ ObjectIndexes.HardwoodFence.GetId(), new CraftableItem(ObjectIndexes.HardwoodFence.GetId(), CraftableCategories.ModerateAndNeedMany) },
				{ ObjectIndexes.Gate.GetId(), new CraftableItem(ObjectIndexes.Gate.GetId(), CraftableCategories.Easy) },
				{ ObjectIndexes.Torch.GetId(), new CraftableItem(ObjectIndexes.Torch.GetId(), CraftableCategories.Easy) { DifficultyToObtain = ObtainingDifficulties.SmallTimeRequirements } }, // You can find it in the mines
				{ ObjectIndexes.Sprinkler.GetId(), new CraftableItem(ObjectIndexes.Sprinkler.GetId(), CraftableCategories.ModerateAndNeedMany) },
				{ ObjectIndexes.QualitySprinkler.GetId(), new CraftableItem(ObjectIndexes.QualitySprinkler.GetId(), CraftableCategories.Moderate) },
				{ ObjectIndexes.IridiumSprinkler.GetId(), new CraftableItem(ObjectIndexes.IridiumSprinkler.GetId(), CraftableCategories.DifficultAndNeedMany) },
				{ ObjectIndexes.BasicFertilizer.GetId(), new CraftableItem(ObjectIndexes.BasicFertilizer.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.QualityFertilizer.GetId(), new CraftableItem(ObjectIndexes.QualityFertilizer.GetId(), CraftableCategories.ModerateAndNeedMany) },
				{ ObjectIndexes.DeluxeFertilizer.GetId(), new CraftableItem(ObjectIndexes.DeluxeFertilizer.GetId(), CraftableCategories.DifficultAndNeedMany) },
				{ ObjectIndexes.BasicRetainingSoil.GetId(), new CraftableItem(ObjectIndexes.BasicRetainingSoil.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.QualityRetainingSoil.GetId(), new CraftableItem(ObjectIndexes.QualityRetainingSoil.GetId(), CraftableCategories.EasyAndNeedMany) },
                { ObjectIndexes.DeluxeRetainingSoil.GetId(), new CraftableItem(ObjectIndexes.DeluxeRetainingSoil.GetId(), CraftableCategories.ModerateAndNeedMany) },
				{ ObjectIndexes.SpeedGro.GetId(), new CraftableItem(ObjectIndexes.SpeedGro.GetId(), CraftableCategories.ModerateAndNeedMany, dataKey: "Speed-Gro") },
				{ ObjectIndexes.DeluxeSpeedGro.GetId(), new CraftableItem(ObjectIndexes.DeluxeSpeedGro.GetId(), CraftableCategories.ModerateAndNeedMany, dataKey: "Deluxe Speed-Gro") },
				{ ObjectIndexes.CherryBomb.GetId(), new CraftableItem(ObjectIndexes.CherryBomb.GetId(), CraftableCategories.Easy) },
				{ ObjectIndexes.Bomb.GetId(), new CraftableItem(ObjectIndexes.Bomb.GetId(), CraftableCategories.Moderate) },
				{ ObjectIndexes.MegaBomb.GetId(), new CraftableItem(ObjectIndexes.MegaBomb.GetId(), CraftableCategories.Difficult) },
				{ ObjectIndexes.ExplosiveAmmo.GetId(), new CraftableItem(ObjectIndexes.ExplosiveAmmo.GetId(), CraftableCategories.ModerateAndNeedMany) },
				// Skipping ancient seeds, as it's just meant to get them from the artifact
				{ ObjectIndexes.SpringSeeds.GetId(), new CraftableItem(ObjectIndexes.SpringSeeds.GetId(), CraftableCategories.Foragables, dataKey: "Wild Seeds (Sp)" ) },
				{ ObjectIndexes.SummerSeeds.GetId(), new CraftableItem(ObjectIndexes.SummerSeeds.GetId(), CraftableCategories.Foragables, dataKey: "Wild Seeds (Su)" ) },
				{ ObjectIndexes.FallSeeds.GetId(), new CraftableItem(ObjectIndexes.FallSeeds.GetId(), CraftableCategories.Foragables, dataKey: "Wild Seeds (Fa)" ) },
                { ObjectIndexes.WinterSeeds.GetId(), new CraftableItem(ObjectIndexes.WinterSeeds.GetId(), CraftableCategories.Foragables, dataKey: "Wild Seeds (Wi)" ) },
                { ObjectIndexes.FiberSeeds.GetId(), new CraftableItem(ObjectIndexes.FiberSeeds.GetId(), CraftableCategories.ModerateAndNeedMany) },
                { ObjectIndexes.TeaSapling.GetId(), new CraftableItem(ObjectIndexes.TeaSapling.GetId(), CraftableCategories.Moderate) },
                { ObjectIndexes.WarpTotemFarm.GetId(), new CraftableItem(ObjectIndexes.WarpTotemFarm.GetId(), CraftableCategories.ModerateAndNeedMany, dataKey: "Warp Totem: Farm") },
				{ ObjectIndexes.WarpTotemMountains.GetId(), new CraftableItem(ObjectIndexes.WarpTotemMountains.GetId(), CraftableCategories.ModerateAndNeedMany, dataKey: "Warp Totem: Mountains") },
				{ ObjectIndexes.WarpTotemBeach.GetId(), new CraftableItem(ObjectIndexes.WarpTotemBeach.GetId(), CraftableCategories.ModerateAndNeedMany, dataKey: "Warp Totem: Beach") },
				{ ObjectIndexes.WarpTotemDesert.GetId(), new CraftableItem(ObjectIndexes.WarpTotemDesert.GetId(), CraftableCategories.ModerateAndNeedMany, dataKey: "Warp Totem: Desert") },
				{ ObjectIndexes.RainTotem.GetId(), new CraftableItem(ObjectIndexes.RainTotem.GetId(), CraftableCategories.Difficult) },
				{ ObjectIndexes.FieldSnack.GetId(), new CraftableItem(ObjectIndexes.FieldSnack.GetId(), CraftableCategories.Easy) },
				{ ObjectIndexes.JackOLantern.GetId(), new CraftableItem(ObjectIndexes.JackOLantern.GetId(), CraftableCategories.DifficultAndNeedMany, dataKey: "Jack-O-Lantern") },
				{ ObjectIndexes.WoodFloor.GetId(), new CraftableItem(ObjectIndexes.WoodFloor.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.StrawFloor.GetId(), new CraftableItem(ObjectIndexes.StrawFloor.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.BrickFloor.GetId(), new CraftableItem(ObjectIndexes.BrickFloor.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.WeatheredFloor.GetId(), new CraftableItem(ObjectIndexes.WeatheredFloor.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.CrystalFloor.GetId(), new CraftableItem(ObjectIndexes.CrystalFloor.GetId(), CraftableCategories.ModerateAndNeedMany) },
				{ ObjectIndexes.StoneFloor.GetId(), new CraftableItem(ObjectIndexes.StoneFloor.GetId(), CraftableCategories.EasyAndNeedMany) },
                { ObjectIndexes.RusticPlankFloor.GetId(), new CraftableItem(ObjectIndexes.RusticPlankFloor.GetId(), CraftableCategories.EasyAndNeedMany) },
                { ObjectIndexes.StoneWalkwayFloor.GetId(), new CraftableItem(ObjectIndexes.StoneWalkwayFloor.GetId(), CraftableCategories.EasyAndNeedMany) },
                { ObjectIndexes.WoodPath.GetId(), new CraftableItem(ObjectIndexes.WoodPath.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.GravelPath.GetId(), new CraftableItem(ObjectIndexes.GravelPath.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.CobblestonePath.GetId(), new CraftableItem(ObjectIndexes.CobblestonePath.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.SteppingStonePath.GetId(), new CraftableItem(ObjectIndexes.SteppingStonePath.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.CrystalPath.GetId(), new CraftableItem(ObjectIndexes.CrystalPath.GetId(), CraftableCategories.ModerateAndNeedMany) },
				{ ObjectIndexes.WildBait.GetId(), new CraftableItem(ObjectIndexes.WildBait.GetId(), CraftableCategories.Easy) },
				{ ObjectIndexes.Bait.GetId(), new CraftableItem(ObjectIndexes.Bait.GetId(), CraftableCategories.EasyAndNeedMany) },
				{ ObjectIndexes.Spinner.GetId(), new CraftableItem(ObjectIndexes.Spinner.GetId(), CraftableCategories.ModerateAndNeedMany) },
				{ ObjectIndexes.Magnet.GetId(), new CraftableItem(ObjectIndexes.Magnet.GetId(), CraftableCategories.ModerateAndNeedMany) },
				{ ObjectIndexes.TrapBobber.GetId(), new CraftableItem(ObjectIndexes.TrapBobber.GetId(), CraftableCategories.Moderate) },
				{ ObjectIndexes.CorkBobber.GetId(), new CraftableItem(ObjectIndexes.CorkBobber.GetId(), CraftableCategories.Moderate) },
				{ ObjectIndexes.DressedSpinner.GetId(), new CraftableItem(ObjectIndexes.DressedSpinner.GetId(), CraftableCategories.Moderate) },
				{ ObjectIndexes.TreasureHunter.GetId(), new CraftableItem(ObjectIndexes.TreasureHunter.GetId(), CraftableCategories.Moderate) },
				{ ObjectIndexes.BarbedHook.GetId(), new CraftableItem(ObjectIndexes.BarbedHook.GetId(), CraftableCategories.Moderate) },
				{ ObjectIndexes.OilOfGarlic.GetId(), new CraftableItem(ObjectIndexes.OilOfGarlic.GetId(), CraftableCategories.Difficult, dataKey: "Oil Of Garlic") },
				{ ObjectIndexes.LifeElixir.GetId(), new CraftableItem(ObjectIndexes.LifeElixir.GetId(), CraftableCategories.DifficultAndNeedMany) },
				{ ObjectIndexes.CrabPot.GetId(), new CraftableItem(ObjectIndexes.CrabPot.GetId(), CraftableCategories.Moderate, overrideBaseLevelLearnedAt: 1) }, // Limit the level you can learn this to prevent it from being learned twice
				{ ObjectIndexes.BugSteak.GetId(), new CraftableItem(ObjectIndexes.BugSteak.GetId(), CraftableCategories.ModerateAndNeedMany) },
				{ ObjectIndexes.IridiumBand.GetId(), new CraftableItem(ObjectIndexes.IridiumBand.GetId(), CraftableCategories.Endgame) { IsRing = true } },
				{ ObjectIndexes.WeddingRing.GetId(), new CraftableItem(ObjectIndexes.WeddingRing.GetId(), CraftableCategories.Endgame) { IsRing = true } },
				{ ObjectIndexes.RingOfYoba.GetId(), new CraftableItem(ObjectIndexes.RingOfYoba.GetId(), CraftableCategories.Difficult) { OverrideName = "Ring of Yoba", IsRing = true } },
				{ ObjectIndexes.SturdyRing.GetId(), new CraftableItem(ObjectIndexes.SturdyRing.GetId(), CraftableCategories.Moderate) { IsRing = true } },
				{ ObjectIndexes.WarriorRing.GetId(), new CraftableItem(ObjectIndexes.WarriorRing.GetId(), CraftableCategories.Moderate) { IsRing = true } },
                { ObjectIndexes.GlowstoneRing.GetId(), new CraftableItem(ObjectIndexes.GlowstoneRing.GetId(), CraftableCategories.Moderate) { IsRing = true } },
                { ObjectIndexes.CookoutKit.GetId(), new CraftableItem(ObjectIndexes.CookoutKit.GetId(), CraftableCategories.Moderate) },
				{ ObjectIndexes.FairyDust.GetId(), new CraftableItem(ObjectIndexes.FairyDust.GetId(), CraftableCategories.Difficult) },
                { ObjectIndexes.DrumBlock.GetId(), new CraftableItem(ObjectIndexes.DrumBlock.GetId(), CraftableCategories.Moderate) { CanStack = false } },
                { ObjectIndexes.FluteBlock.GetId(), new CraftableItem(ObjectIndexes.FluteBlock.GetId(), CraftableCategories.Moderate) { CanStack = false } },
				{ ObjectIndexes.MonsterMusk.GetId(), new CraftableItem(ObjectIndexes.MonsterMusk.GetId(), CraftableCategories.Moderate) },
				...
				{ ObjectIndexes.GrassStarter.GetId(), new Item(ObjectIndexes.GrassStarter.GetId(), ObtainingDifficulties.NonCraftingItem) },
				...
				{ ObjectIndexes.AncientSeeds.GetId(), new SeedItem(ObjectIndexes.AncientSeeds) { Randomize = false } },
				{ ObjectIndexes.CactusSeeds.GetId(), new SeedItem(ObjectIndexes.CactusSeeds) },
				{ ObjectIndexes.RareSeed.GetId(), new SeedItem(ObjectIndexes.RareSeed) },
			...
			{
				{ BigCraftableIndexes.Chest.GetId(), new CraftableItem(BigCraftableIndexes.Chest.GetId(), CraftableCategories.Easy, isBigCraftable: true) },
                { BigCraftableIndexes.StoneChest.GetId(), new CraftableItem(BigCraftableIndexes.StoneChest.GetId(), CraftableCategories.Easy, isBigCraftable: true) },
                { BigCraftableIndexes.Scarecrow.GetId(), new CraftableItem(BigCraftableIndexes.Scarecrow.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.BeeHouse.GetId(), new CraftableItem(BigCraftableIndexes.BeeHouse.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.Keg.GetId(), new CraftableItem(BigCraftableIndexes.Keg.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.Cask.GetId(), new CraftableItem(BigCraftableIndexes.Cask.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.Furnace.GetId(), new CraftableItem(BigCraftableIndexes.Furnace.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.GardenPot.GetId(), new CraftableItem(BigCraftableIndexes.GardenPot.GetId(), CraftableCategories.Easy, isBigCraftable: true) },
				{ BigCraftableIndexes.WoodSign.GetId(), new CraftableItem(BigCraftableIndexes.WoodSign.GetId(), CraftableCategories.Easy, isBigCraftable: true) },
				{ BigCraftableIndexes.StoneSign.GetId(), new CraftableItem(BigCraftableIndexes.StoneSign.GetId(), CraftableCategories.Easy, isBigCraftable: true) },
                { BigCraftableIndexes.DarkSign.GetId(), new CraftableItem(BigCraftableIndexes.DarkSign.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
                { BigCraftableIndexes.CheesePress.GetId(), new CraftableItem(BigCraftableIndexes.CheesePress.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.MayonnaiseMachine.GetId(), new CraftableItem(BigCraftableIndexes.MayonnaiseMachine.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.SeedMaker.GetId(), new CraftableItem(BigCraftableIndexes.SeedMaker.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.Loom.GetId(), new CraftableItem(BigCraftableIndexes.Loom.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.OilMaker.GetId(), new CraftableItem(BigCraftableIndexes.OilMaker.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.RecyclingMachine.GetId(), new CraftableItem(BigCraftableIndexes.RecyclingMachine.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.WormBin.GetId(), new CraftableItem(BigCraftableIndexes.WormBin.GetId(), CraftableCategories.Difficult, isBigCraftable: true) },
				{ BigCraftableIndexes.PreservesJar.GetId(), new CraftableItem(BigCraftableIndexes.PreservesJar.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.CharcoalKiln.GetId(), new CraftableItem(BigCraftableIndexes.CharcoalKiln.GetId(), CraftableCategories.Easy, isBigCraftable: true) },
				{ BigCraftableIndexes.Tapper.GetId(), new CraftableItem(BigCraftableIndexes.Tapper.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.LightningRod.GetId(), new CraftableItem(BigCraftableIndexes.LightningRod.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.SlimeIncubator.GetId(), new CraftableItem(BigCraftableIndexes.SlimeIncubator.GetId(), CraftableCategories.Difficult, isBigCraftable: true) },
				{ BigCraftableIndexes.SlimeEggPress.GetId(), new CraftableItem(BigCraftableIndexes.SlimeEggPress.GetId(), CraftableCategories.DifficultAndNeedMany, isBigCraftable: true, dataKey: "Slime Egg-Press") },
				{ BigCraftableIndexes.Crystalarium.GetId(), new CraftableItem(BigCraftableIndexes.Crystalarium.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.MiniJukebox.GetId(), new CraftableItem(BigCraftableIndexes.MiniJukebox.GetId(), CraftableCategories.Moderate, isBigCraftable: true, dataKey: "Mini-Jukebox") },
				{ BigCraftableIndexes.Staircase.GetId(), new CraftableItem(BigCraftableIndexes.Staircase.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.BoneMill.GetId(), new CraftableItem(BigCraftableIndexes.BoneMill.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.TubOFlowers.GetId(), new CraftableItem(BigCraftableIndexes.TubOFlowers.GetId(), CraftableCategories.Easy, isBigCraftable: true, dataKey: "Tub o' Flowers") },
				{ BigCraftableIndexes.WoodenBrazier.GetId(), new CraftableItem(BigCraftableIndexes.WoodenBrazier.GetId(), CraftableCategories.Easy, isBigCraftable: true) },
				{ BigCraftableIndexes.WickedStatue.GetId(), new CraftableItem(BigCraftableIndexes.WickedStatue.GetId(), CraftableCategories.Easy, isBigCraftable: true) },
				{ BigCraftableIndexes.StoneBrazier.GetId(), new CraftableItem(BigCraftableIndexes.StoneBrazier.GetId(), CraftableCategories.Easy, isBigCraftable: true) },
				{ BigCraftableIndexes.GoldBrazier.GetId(), new CraftableItem(BigCraftableIndexes.GoldBrazier.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.Campfire.GetId(), new CraftableItem(BigCraftableIndexes.Campfire.GetId(), CraftableCategories.Easy, isBigCraftable: true) },
				{ BigCraftableIndexes.StumpBrazier.GetId(), new CraftableItem(BigCraftableIndexes.StumpBrazier.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.CarvedBrazier.GetId(), new CraftableItem(BigCraftableIndexes.CarvedBrazier.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.SkullBrazier.GetId(), new CraftableItem(BigCraftableIndexes.SkullBrazier.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.BarrelBrazier.GetId(), new CraftableItem(BigCraftableIndexes.BarrelBrazier.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
				{ BigCraftableIndexes.MarbleBrazier.GetId(), new CraftableItem(BigCraftableIndexes.MarbleBrazier.GetId(), CraftableCategories.Difficult, isBigCraftable: true) },
				{ BigCraftableIndexes.WoodLampPost.GetId(), new CraftableItem(BigCraftableIndexes.WoodLampPost.GetId(), CraftableCategories.Moderate, isBigCraftable: true, dataKey : "Wood Lamp-post") },
				{ BigCraftableIndexes.IronLampPost.GetId(), new CraftableItem(BigCraftableIndexes.IronLampPost.GetId(), CraftableCategories.Moderate, isBigCraftable: true, dataKey : "Iron Lamp-post") },
                { BigCraftableIndexes.DeluxeScarecrow.GetId(), new CraftableItem(BigCraftableIndexes.DeluxeScarecrow.GetId(), CraftableCategories.Endgame, isBigCraftable: true) },
                { BigCraftableIndexes.GeodeCrusher.GetId(), new CraftableItem(BigCraftableIndexes.GeodeCrusher.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
                { BigCraftableIndexes.SolarPanel.GetId(), new CraftableItem(BigCraftableIndexes.SolarPanel.GetId(), CraftableCategories.Moderate, isBigCraftable: true) },
                { BigCraftableIndexes.MiniObelisk.GetId(), new CraftableItem(BigCraftableIndexes.MiniObelisk.GetId(), CraftableCategories.Difficult, isBigCraftable: true, dataKey: "Mini-Obelisk") },
                { BigCraftableIndexes.FarmComputer.GetId(), new CraftableItem(BigCraftableIndexes.FarmComputer.GetId(), CraftableCategories.Difficult, isBigCraftable: true) },

				// Non-craftable BigObjects
				{ BigCraftableIndexes.Heater.GetId(), new Item(BigCraftableIndexes.Heater.GetId(), ObtainingDifficulties.NonCraftingItem, isBigCraftable: true) },
				{ BigCraftableIndexes.AutoGrabber.GetId(), new Item(BigCraftableIndexes.AutoGrabber.GetId(), ObtainingDifficulties.NonCraftingItem, isBigCraftable: true) },
				{ BigCraftableIndexes.PrairieKingArcadeSystem.GetId(), new Item(BigCraftableIndexes.PrairieKingArcadeSystem.GetId(), ObtainingDifficulties.NonCraftingItem, isBigCraftable: true) },
				{ BigCraftableIndexes.JunimoKartArcadeSystem.GetId(), new Item(BigCraftableIndexes.JunimoKartArcadeSystem.GetId(), ObtainingDifficulties.NonCraftingItem, isBigCraftable: true) },
				{ BigCraftableIndexes.SodaMachine.GetId(), new Item(BigCraftableIndexes.SodaMachine.GetId(), ObtainingDifficulties.NonCraftingItem, isBigCraftable: true) },
				{ BigCraftableIndexes.HMTGF.GetId(), new Item(BigCraftableIndexes.HMTGF.GetId(), ObtainingDifficulties.NonCraftingItem, isBigCraftable: true) { OverrideName = "??HMTGF??" } },
				{ BigCraftableIndexes.PinkyLemon.GetId(), new Item(BigCraftableIndexes.PinkyLemon.GetId(), ObtainingDifficulties.NonCraftingItem, isBigCraftable: true) { OverrideName = "??Pinky Lemon??" } },
				{ BigCraftableIndexes.Foroguemon.GetId(), new Item(BigCraftableIndexes.Foroguemon.GetId(), ObtainingDifficulties.NonCraftingItem, isBigCraftable: true) { OverrideName = "??Foroguemon??" } },
				{ BigCraftableIndexes.SolidGoldLewis.GetId(), new Item(BigCraftableIndexes.SolidGoldLewis.GetId(), ObtainingDifficulties.NonCraftingItem, isBigCraftable: true) },
				{ BigCraftableIndexes.StardewHeroTrophy.GetId(), new Item(BigCraftableIndexes.StardewHeroTrophy.GetId(), ObtainingDifficulties.NonCraftingItem, isBigCraftable: true) }
			};
