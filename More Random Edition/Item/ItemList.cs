    ...
    public class ItemList
	{
        ...
        public static void Initialize()
		{
			...
			{ 
				...
				{ ObjectIndexes.QualityFertilizer, new CraftableItem((int)ObjectIndexes.QualityFertilizer, CraftableCategories.ModerateAndNeedMany) },
				{ ObjectIndexes.DeluxeFertilizer, new CraftableItem((int)ObjectIndexes.DeluxeFertilizer, CraftableCategories.DifficultAndNeedMany) },
                ...
                { ObjectIndexes.DeluxeRetainingSoil, new CraftableItem((int)ObjectIndexes.DeluxeRetainingSoil, CraftableCategories.ModerateAndNeedMany) },
                ...
                { ObjectIndexes.FiberSeeds, new CraftableItem((int)ObjectIndexes.FiberSeeds, CraftableCategories.ModerateAndNeedMany) },
                { ObjectIndexes.TeaSapling, new CraftableItem((int)ObjectIndexes.TeaSapling, CraftableCategories.Moderate) },
                ...
                { ObjectIndexes.RusticPlankFloor, new CraftableItem((int)ObjectIndexes.RusticPlankFloor, CraftableCategories.EasyAndNeedMany) },
                { ObjectIndexes.StoneWalkwayFloor, new CraftableItem((int)ObjectIndexes.StoneWalkwayFloor, CraftableCategories.EasyAndNeedMany) },
                ...
                { ObjectIndexes.GlowstoneRing, new CraftableItem((int)ObjectIndexes.GlowstoneRing, CraftableCategories.Moderate) { IsRing = true } },
                { ObjectIndexes.CookoutKit, new CraftableItem((int)ObjectIndexes.CookoutKit, CraftableCategories.Moderate) },
				{ ObjectIndexes.FairyDust, new CraftableItem((int)ObjectIndexes.FairyDust, CraftableCategories.Difficult) },
                { ObjectIndexes.DrumBlock, new CraftableItem((int)ObjectIndexes.DrumBlock, CraftableCategories.Moderate) { CanStack = false } },
                { ObjectIndexes.FluteBlock, new CraftableItem((int)ObjectIndexes.FluteBlock, CraftableCategories.Moderate) { CanStack = false } },
				{ ObjectIndexes.MonsterMusk, new CraftableItem((int)ObjectIndexes.MonsterMusk, CraftableCategories.Moderate) },
				...
				{ ObjectIndexes.IridiumOre, new Item((int)ObjectIndexes.IridiumOre, ObtainingDifficulties.EndgameItem) { ItemsRequiredForRecipe = new Range(1, 3) } },
				...
				{ ObjectIndexes.FireQuartz, new Item((int)ObjectIndexes.FireQuartz, ObtainingDifficulties.MediumTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 2) } },
				{ ObjectIndexes.EarthCrystal, new Item((int)ObjectIndexes.EarthCrystal, ObtainingDifficulties.SmallTimeRequirements) },
				{ ObjectIndexes.FrozenTear, new Item((int)ObjectIndexes.FrozenTear, ObtainingDifficulties.MediumTimeRequirements) { ItemsRequiredForRecipe = new Range(1, 2) } },
			...
			BigCraftableItems = new Dictionary<BigCraftableIndexes, Item>()
			{
                ...
                { BigCraftableIndexes.StoneChest, new CraftableItem((int)BigCraftableIndexes.StoneChest, CraftableCategories.Easy, isBigCraftable: true) },
                ...
                { BigCraftableIndexes.DarkSign, new CraftableItem((int)BigCraftableIndexes.DarkSign,  CraftableCategories.Moderate, isBigCraftable: true) },
                ...
                { BigCraftableIndexes.DeluxeScarecrow, new CraftableItem((int)BigCraftableIndexes.DeluxeScarecrow, CraftableCategories.Endgame, isBigCraftable: true) },
                { BigCraftableIndexes.GeodeCrusher, new CraftableItem((int)BigCraftableIndexes.GeodeCrusher, CraftableCategories.Moderate, isBigCraftable: true) },
                { BigCraftableIndexes.SolarPanel, new CraftableItem((int)BigCraftableIndexes.SolarPanel, CraftableCategories.Moderate, isBigCraftable: true) },
                { BigCraftableIndexes.MiniObelisk, new CraftableItem((int)BigCraftableIndexes.MiniObelisk, CraftableCategories.Difficult, isBigCraftable: true, dataKey: "Mini-Obelisk") },
                { BigCraftableIndexes.FarmComputer, new CraftableItem((int)BigCraftableIndexes.FarmComputer, CraftableCategories.Difficult, isBigCraftable: true) },
