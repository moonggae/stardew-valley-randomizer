    ...
    public class ItemList
	{
        ...
        public static void Initialize()
		{
			...
			{ 
				...
				{ ObjectIndexes.SpeedGro, new CraftableItem((int)ObjectIndexes.SpeedGro, CraftableCategories.ModerateAndNeedMany) { OverrideName = "Speed-Gro" } },
				{ ObjectIndexes.DeluxeSpeedGro, new CraftableItem((int)ObjectIndexes.DeluxeSpeedGro, CraftableCategories.ModerateAndNeedMany) { OverrideName = "Deluxe Speed-Gro" } },
				...
				{ ObjectIndexes.WarpTotemFarm, new CraftableItem((int)ObjectIndexes.WarpTotemFarm, CraftableCategories.ModerateAndNeedMany) { OverrideName = "Warp Totem: Farm" } },
				{ ObjectIndexes.WarpTotemMountains, new CraftableItem((int)ObjectIndexes.WarpTotemMountains, CraftableCategories.ModerateAndNeedMany) { OverrideName = "Warp Totem: Mountains" } },
				{ ObjectIndexes.WarpTotemBeach, new CraftableItem((int)ObjectIndexes.WarpTotemBeach, CraftableCategories.ModerateAndNeedMany) { OverrideName = "Warp Totem: Beach" } },
				{ ObjectIndexes.WarpTotemDesert, new CraftableItem((int)ObjectIndexes.WarpTotemDesert, CraftableCategories.ModerateAndNeedMany) { OverrideName = "Warp Totem: Desert" } },
				...
				{ ObjectIndexes.JackOLantern, new CraftableItem((int)ObjectIndexes.JackOLantern, CraftableCategories.DifficultAndNeedMany) { OverrideName = "Jack-O-Lantern" } },
