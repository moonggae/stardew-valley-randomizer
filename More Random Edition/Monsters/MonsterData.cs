...
namespace Randomizer
{
	...
	public class MonsterData
	{
		...
		public static List<string> DefaultStringData = new List<string>
		{
			...
			"1/18/0/0/true/0/768 .75 814 .2 336 .05 287 .1 288 .05 98 .005 99 .001/2/0/6/3/.0/true/15/Squid Kid",
			...
			$"160/18/0/0/false/0/769 .75 769 .1 337 .002 336 .01 335 .02 334 .04 203 .04 108 .003 {(int)ObjectIndexes.Coal} .1 98 .005 99 .001 74 .0005/2/.01/8/3/.0/true/15/Shadow Brute",
